...
<br><br>
With regards to code analysis in general, there are a few things to keep in mind; the most important factor for accurate results is to identify the project folder and not analyze system and dependency files. This can be done in different ways:
<br>
